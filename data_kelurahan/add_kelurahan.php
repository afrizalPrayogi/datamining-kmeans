                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal p-t-20" method="POST" action="" enctype="multipart/form-data" id="myForm">
                                    <div class="form-group row">
                                        <label for="id_kelurahan" class="col-sm-2 control-label">ID Barang<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label for="nama_kelurahan" class="col-sm-2 control-label">Nama Barang<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
