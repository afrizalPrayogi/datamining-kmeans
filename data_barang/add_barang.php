...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $result = addBarang($_POST);
    if ($result > 0) {
        echo json_encode(["status" => "success", "message" => "Data Berhasil Ditambahkan"]);
    } elseif ($result == -1) {
        echo json_encode(["status" => "error", "message" => "Nama Barang Sudah Ada"]);
    } elseif ($result == -2) {
        echo json_encode(["status" => "error", "message" => "ID Barang Sudah Ada"]);
    } else {
...
<head>
    ...
    <title>Tambah Barang - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Tambah Barang</h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal p-t-20" method="POST" action="" enctype="multipart/form-data" id="myForm">
                                    <div class="form-group row">
                                        <label for="id_barang" class="col-sm-2 control-label">ID Barang<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="id_barang" name="id_barang" placeholder="ID Barang" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="nama_barang" class="col-sm-2 control-label">Nama Barang<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
