...
<head>
    ...
    <title>Data Barang - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Data Barang</h4>
                    </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <div class="d-flex">
                                                ...
                                                <div class="float-start">
                                                    <a href="add_barang.php" class="btn btn-secondary btn-rounded btn-info"><i class="fa fa-plus"></i> Tambah</a>
                                                </div>
                                            </div>
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                        <li><a class="dropdown-item" href="edit_barang.php?id_barang=<?= $barang["id_barang"]; ?>">Edit</a></li>
                                                                        <li><a class="dropdown-item tombol-hapus" href="delete_barang.php?id_barang=<?= $barang["id_barang"]; ?>">Delete</a></li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                        </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            function handleSearchQuery() {
                ...
                $.get('../ajax/data_barang.php?keyword=' + keyword, function(data) {
