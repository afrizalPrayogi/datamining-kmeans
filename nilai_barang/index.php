...
$barang = query("SELECT * FROM data_barang LIMIT $awalData, $jumlahDataPerHalaman");
$atribut = query("SELECT * FROM atribut");

if ($halamanAktif > $jumlahHalaman) {
    header("Location: ../nilai_barang");
    exit();
}
...
<head>
    ...
    <title>Nilai Barang - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Data Nilai Barang</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item active">Data Nilai Barang</li>
                            </ol>
                            <!-- <a href="add_barang.php"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Tambah barang</button></a> -->
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Data Nilai Barang</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            function handleSearchQuery() {
                ...
                $.get('../ajax/data_nilaibarang.php?keyword=' + keyword, function(data) {
