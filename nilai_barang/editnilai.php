...
$barang = query("SELECT * FROM data_barang WHERE id_barang = $id_barang")[0];
...
<head>
    ...
    <title>Edit Nilai Barang - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Nilai Barang</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb justify-content-end">
                                ...
                                <li class="breadcrumb-item">Edit Nilai Barang</li>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Nilai Barang</h4>
                                <h6 class="card-subtitle"><?= $barang["nama_barang"]; ?></h6>
                                <form class="form-horizontal p-t-20" method="POST" action="" enctype="multipart/form-data" id="myForm">
                                    ...
                                    <?php foreach ($atribut as $row) : ?>
                                        <div class="form-group row">
                                            ...
                                            <?php $nilaibarang = query("SELECT * FROM data_nilai_barang WHERE id_barang = " . $barang['id_barang'] . " AND id_atribut = " . $row['id_atribut']); ?>
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <!-- <span class="input-group-text"></span> -->
                                                    <?php if ($nilaibarang) {
                                                        echo '<input type="number" class="form-control" id="' . $row["id_atribut"] . '" name="' . $row["id_atribut"] . '" placeholder="Nilai" value="' . $nilaibarang[0]["nilai"] . '">';
                                                    } else {
                    ...
                    success: function(response) {
                        ...
                        if (res.status === 'success') {
                            Swal.fire({
                                ...
                                window.location.href = '../nilai_barang';
                            });
                        } else {
