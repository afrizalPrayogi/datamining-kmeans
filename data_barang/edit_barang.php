...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $result = editBarang($_POST);
    if ($result > 0) {
        echo json_encode(["status" => "success", "message" => "Data Berhasil Diubah"]);
    } elseif ($result == -1) {
        echo json_encode(["status" => "error", "message" => "Nama Barang Sudah Ada Sebelumnya"]);
    } else {
...
<head>
    ...
    <title>Edit Barang - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Barang</h4>
                    </div>
